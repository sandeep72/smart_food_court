...
public class RestaurantCompleteOrderHistory extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.restaurant_complete_order_history);
		getActionBar().setTitle(Html.fromHtml("<font color='#ffe779'>Food Order History</font>"));
		Log.i("all orders delete oncreate", "on create");
	...
	private class AddNewPrediction extends AsyncTask<String, Void, Void> {
        ...
        @Override
            ...
            Log.d("url: ", "> " + RestaurantConfig.URL_ITEMS+"ReadAllOrdersHistory.php");
            String json = serviceClient.makeServiceCall(RestaurantConfig.URL_ITEMS+"ReadAllOrdersHistory.php",ServiceHandler.POST,params);
            Log.i("json",json);
        ...
        @Override
            ...
            ListView listView=(ListView) findViewById(R.id.allOrdersListView);
	...
	private class MyListAdapter extends ArrayAdapter<RestaurantNotificationFieldClass>{
		...
		public MyListAdapter() {
			super(RestaurantCompleteOrderHistory.this, R.layout.restaurant_notification_list_row,list);
	...
	//adding the column headers
			...
			restaurantOrderDeleteButton.setVisibility(View.INVISIBLE);
...
//					Intent i = new Intent(RestaurantCompleteOrderHistory.this,RestaurantDeleteOrderProcess.class);
