...
public class RestaurantEditMenuFragment extends Activity{
	...
	static	HashMap<String,List<String>> listDataId = new HashMap<String, List<String>>();
		...
		private class AddNewPrediction extends AsyncTask<Void, Void, Void> {
	        ...
	        @Override
	          ...
	          //  Log.d("url: ", "> "+ URL_ITEMS);
	            ...
	            String json = serviceClient.makeServiceCall(RestaurantConfig.URL_ITEMS+"getcategory.php",ServiceHandler.POST,params);
	            String json1 = serviceClient.makeServiceCall(RestaurantConfig.URL_ITEMS+"getmenuitems.php",ServiceHandler.POST,params);
	      ...
	      Intent i=new Intent(RestaurantEditMenuFragment.this,RestaurantMenuTabPage.class);
	      startActivity(i);
