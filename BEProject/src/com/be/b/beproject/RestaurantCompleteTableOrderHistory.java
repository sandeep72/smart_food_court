...
public class RestaurantCompleteTableOrderHistory extends Activity{
	//SQLiteDatabase dbHandler;
		...
		TextView t1,t2,t3,t4,t5,t6,t7,t8,t10,t11,t12;
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.restauranttableordercompletehistory);
			getActionBar().setTitle(Html.fromHtml("<font color='#ffe779'>Table Order History</font>"));
			
			listView=(SwipeListView) findViewById(R.id.tableOrderCompleteHistoryListView);
		...
		public void onBackPressed() {
			// TODO Auto-generated method stub
			super.onBackPressed();
//			Intent i=new Intent(RestaurantCompleteTableOrderHistory.this,RestaurantHomeActivity.class);
//			startActivity(i);
			finish();
		}
	        ...
	        @Override
	            ...
	            Log.d("url: ", "> " + RestaurantConfig.URL_ITEMS+"RestaurantCompleteTableOrderHistory.php");
	            String json = serviceClient.makeServiceCall(RestaurantConfig.URL_ITEMS+"RestaurantCompleteTableOrderHistory.php",ServiceHandler.POST,params);
	            Log.i("json",json);
	            ...
	            if (json != null) {
	                try {
	                    ...
	                    for (int i = 0; i < jArray.length(); i++) {
	                       ...
	                       list.add(new RestaurantTableOrderNotificationFieldClass(TableOrderId, CustomerName, CustomerPhone,NoOfSeats,Time,Date,CustomerId,Flag,Amount,TypeOfPayment,ItemNames));
	                     }
	                }
		...
		private class MyListAdapter extends ArrayAdapter<RestaurantTableOrderNotificationFieldClass>{
			...
			public MyListAdapter() {
				super(RestaurantCompleteTableOrderHistory.this, R.layout.restaurant_table_order_notification_list_row,list);
...
//				if(!obj.getTypeOfPayment().equalsIgnoreCase("x")){
...
//					}else{
//						t10=(TextView) itemView.findViewById(R.id.textView4);
//						t10.setText("");
//						t11=(TextView) itemView.findViewById(R.id.textView6);
//						t11.setText("there is no food order associated with this table order ");
//					}
				
				Button restaurantTableConfirmButton=(Button) itemView.findViewById(R.id.restaurantTableOrderConfirmButton);
				restaurantTableConfirmButton.setVisibility(View.INVISIBLE);
